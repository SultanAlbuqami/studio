  ...
  (
    ...
    return (
      <div
        ref={ref}
        className={cn(
          "grid min-w-[8rem] items-start gap-1.5 rounded-[1rem] border border-white/10 bg-background/92 px-3 py-2 text-xs shadow-[0_18px_36px_rgba(2,8,24,0.5)] backdrop-blur-xl",
          className
        )}
      >
  ...
  (
    ...
    return (
      <div
        ref={ref}
        className={cn(
          "flex items-center justify-center gap-4 text-[11px] uppercase tracking-[0.18em] text-muted-foreground/72",
